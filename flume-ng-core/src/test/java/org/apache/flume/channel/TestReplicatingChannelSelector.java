...
public class TestReplicatingChannelSelector {
  ...
  public void setUp() throws Exception {
    ...
    channels.add(createMockChannel("ch4"));
  ...
  public void testReplicatingSelector() throws Exception {
    ...
    List<Channel> channels = selector.getRequiredChannels(new SimpleEvent());
    ...
    List<Channel> optCh = selector.getOptionalChannels(new SimpleEvent());
